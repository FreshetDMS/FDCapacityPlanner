...
class LogStoreCapacityPlannerTestCase(unittest.TestCase):
    def setUp(self):
        self.node_types = []
        self.node_types.append(EC2Instance("m4.xlarge", 4, 16 * 1024, 125, 750/8, 1))
        self.node_types.append(EC2Instance("m4.2xlarge", 8, 32 * 1024, 125, 1000/8, 2))
        self.node_types.append(EC2Instance("m4.4xlarge", 16, 64 * 1024, 125, 2000/8, 4))
        self.node_types.append(EC2Instance("m4.10xlarge", 40, 160 * 1024, 1250, 4000/8, 10))
        self.node_types.append(EC2Instance("m4.16xlarge", 64, 256 * 1024, 2500, 1050/8, 16))
